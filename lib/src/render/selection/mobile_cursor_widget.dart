...
class MobileCursorWidget extends StatefulWidget {
  const MobileCursorWidget({
    Key? key,
  ...
  @override
  State<MobileCursorWidget> createState() => MobileCursorWidgetState();
}

class MobileCursorWidgetState extends State<MobileCursorWidget> {
